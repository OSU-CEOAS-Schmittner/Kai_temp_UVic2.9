! source file: /home/kai/UVic2.9/default_comb2/nobio_cons_kgm/updates/isopyc.F
...
!     &        p5*(kgm(i,jrow,k)+kgm(i+1,jrow,k)) !AHO
            Ai0 = p5*(fisop(i,jrow,k) + fisop(i+1,jrow+1,k)) *
     &        p5*(ahisop_var(i,jrow,k)+ahisop_var(i+1,jrow,k))
...
!       VERY HACKISH way of resetting kgm to a constant of 800m^2/s
            kgm(i,jrow,1) = 8.e6
            kgm_sum = kgm_sum + kgm(i,jrow,1)
        enddo
      enddo
