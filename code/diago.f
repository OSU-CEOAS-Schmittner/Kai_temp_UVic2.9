! source file: /raid24/aschmitt/UVic2.9/karin/mwc15_npzd_fe_n15_c13_alk_caco3/updates/diago.F
      subroutine diago
...
!-----------------------------------------------------------------------
     ...
     &,                   tai_c, tai_coccn15, tai_coccc13, tai_caco3
     &,                   tai_caco3c13
     &       )
...
!                      = sum[((rho1-rho2)/rho0)*dvol]/area
        ...
        tai_coccn15 = tai_coccn15 + tbar(0,icoccn15,1)
        ...
        tai_coccc13 = tai_coccc13 + tbar(0,icoccc13,1)
...
!       average
        ...
        tai_c = tai_c*rntatio
        tai_coccc13 = tai_coccc13*rntatio
